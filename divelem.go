...
func (m1 *DivElem) Copy() MatrixExpr {
	return &DivElem{
		Left:  m1.Left.Copy(),
		Right: m1.Right.Copy(),
	}
...
func (m1 *DivElem) T() MatrixExpr {
	return &T{m1}
}

// Add two matrices together.
func (m1 *DivElem) Add(m2 MatrixExpr) MatrixExpr {
	return &Add{
		Left:  m1,
		Right: m2,
	}
...
func (m1 *DivElem) Sub(m2 MatrixExpr) MatrixExpr {
	return &Sub{
		Left:  m1,
		Right: m2,
	}
...
func (m1 *DivElem) Scale(c float64) MatrixExpr {
	return &Scale{
		C: c,
		M: m1,
	}
...
func (m1 *DivElem) Mul(m2 MatrixExpr) MatrixExpr {
	return &Mul{
		Left:  m1,
		Right: m2,
	}
...
func (m1 *DivElem) MulElem(m2 MatrixExpr) MatrixExpr {
	return &MulElem{
		Left:  m1,
		Right: m2,
	}
...
func (m1 *DivElem) DivElem(m2 MatrixExpr) MatrixExpr {
	return &DivElem{
		Left:  m1,
		Right: m2,
	}
